    ...
    <section class="main">
        <div class="main__content container">
            <div class="main__content_info">
                <h1 class="main__content_info-title">web applications</h1>
                <p class="main__content_info-text">Повседневная практика.</p>
                <a href="#" class="main__content_info-btn btn">Спец предложение
